...
class PrepaidLiabilitySqlTests(unittest.TestCase):
    ...
    def test_service_recognition_crosswalk_seed_covers_fc_tags_and_qbo_matches(self) -> None:
        ...
        self.assertIn("'1040 Advanced', 'tax', 'Advanced', 'tax_filing', 'tax_year_default', 104, '1040', 'Tier is complexity, not timing.', 'S 1040A'", sql)
        ...
        self.assertIn("'1040 Advanced', 'tax', 'Advanced', 'tax_filing', 'tax_year_default', 104, '1040', 'Tier is complexity, not timing.', 'S 1040A', 'Tax Work', '1040 Advanced'", sql)
